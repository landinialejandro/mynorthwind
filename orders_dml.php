...
function orders_insert() {
	...
	$data = array();
	$data['orderNumber'] = br2nl($_REQUEST['orderNumber']);
...
function orders_update($selected_id) {
	...
	$data['orderNumber'] = br2nl(makeSafe($_REQUEST['orderNumber']));
...
function orders_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	if($selected_id) {
		...
		if($dvprint || (!$AllowUpdate && !$AllowInsert)) {
			$templateCode = str_replace('<%%VALUE(orderNumber)%%>', safe_html($urow['orderNumber']), $templateCode);
		}else{
			$templateCode = str_replace('<%%VALUE(orderNumber)%%>', html_attr($row['orderNumber']), $templateCode);
		}
