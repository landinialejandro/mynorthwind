<?php
	include(dirname(__FILE__).'/tvedit_class.php');
	
	$tve_class = new tve_class(array(
		'title' => 'Landini TV edit Enable',
		'name' => 'tvedit',
		'logo' => 'tvedit.mid.png'
	));
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<head>
		...
		<title>Landini Table View edit for AppGini</title>
		
		<link id="browser_favicon" rel="shortcut icon" href="<?php echo PREPEND_PATH; ?>plugins/LAT/tvedit.min.png">

		<?php echo $tve_class->get_theme_css_links(); ?>
		...
		<script src="<?php echo PREPEND_PATH; ?>resources/jquery/js/<?php echo $tve_class->get_jquery(); ?>"></script>
...
<?php
	...
	if (!$tve_class->is_admin() ){
		echo "<br>".$tve_class->error_message('Access denied.<br>Please, <a href=\'' . PREPEND_PATH . 'index.php?signIn=1\' >Log in</a> as administrator to access this page.' , false);
		exit;
	}
